...
// 메소드 : 기능을 수행하기 위한 코드. 주로 반복적으로 기능을 수행 할 때 생성
...
public class MethodMain01 {
	...
	// static 수시어 : 프로그램이 실행될 때 생성 하도록 선언 하는 키워드
	// * static 메소드에서는 static으로 선언 된 메소드만 호출 가능
	public static void main(String[] args) {
		System.out.println("저는 컴퓨터입니다.");
		System.out.println("저는 스마트폰입니다.");
		
		sayHello("목진혁"); // 메소드 호출. 인자값으로 "목진혁"을 넘겨줌
		sayHello("우제영");
