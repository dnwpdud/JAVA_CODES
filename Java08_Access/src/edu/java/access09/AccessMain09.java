...
// 	 static - 프로그램이 첨음 실행될 때 메모리에 생성

// * 클래스 멤버변수(static 변수) : static으로 선언한 멤버 변수
// - 인스턴스를 생성하지 않아도 사용 가능
// - static 변수는 메소드 여역에 생성된 공간에서 공유됨
// - 모든 인스턴스들이 공유 하기 때문에 값의 변경에 대해서 주의해야 함!
// - 사용 형식:
// 			클래스이름, 변수이름

// * 인스턴스 멤버변수 : static이 선언되지 않은 멤버 변수
