...
public class CollectionMain05 {
	...
	public static void main(String[] args) {
		...
		// 	 hasNect() : Iterator 객체가 가리키는 위치에
		//				원소가 있는지(true), 없는지(false)를 리턴하는 메소드
		// 	 next() : Iterator 객체가 가리키는 위를 다음 위치로 이동하고,
		...
		//Iterator 인터체이스 : 컬렉션 프레임워크의 표준 인터페이스
		...
		// 데이터 변겨을 위한 set(index, element) 메소드를 제공하지 않음
